...
<html lang="fr">
    <head>
        ...
        <title>Fournisseur - enregistrement</title>
    ...
    <body>
        ...
        <div class="row">
            ...
            <form name="myForm" onsubmit="return validateForm()" action="./enregistdata.php" method="POST" style="background-color:#AAE0CA; ">
                <div> 
                    <h3 style="text-align: center;font-family: Verdana;color: #445950;">Fournisseurs - enregistrement</h3>
                    <hr class="my-1" style="background-color: #C0C0C0; border-width: 2px;">
                </div> 
                
                <input type="hidden" name="id_enregist" value="fourn"> 

                    <div class="form-group row my-0">
                         <div class="col-sm-1"></div>
                         <label class="col-sm-2 align-self-center" for="last_name">Société:</label>
                        <div class="col-sm-3">
                            <input type="text" maxlength="25" size="25" name="s_societe" class="form-control" id="Société" placeholder="Société" required>
                        </div>              
                        
                        <label class="col-sm-1 align-self-center" for="first_name">SIREN:</label>
                        <div class="col-sm-3">
                            <input type="text" maxlength="25" size="25" name="s_siren" class="form-control" id="siren" placeholder="siren" required >
                        </div>
                    </div>                
                    ...
                    <div class="form-group row my-0">
                         <div class="col-sm-1"></div>
                         <label class="col-sm-2 align-self-center" for="contact">Contact:</label>
                        <div class="col-sm-5">
                            <input type="text" maxlength="40" size="40" name="s_contact" class="form-control" id="Contact" placeholder="Contact" required>
                        </div>  
                    </div>                   
